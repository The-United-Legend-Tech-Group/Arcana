...
import { /*SystemRole, EmployeeStatus,*/ CandidateStatus, SystemRole } from '../employee-profile/enums/employee-profile.enums';
import type { UpdateCandidateStatusDto } from '../employee-profile/dto/update-candidate-status.dto';
