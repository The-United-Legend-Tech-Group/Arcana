...
import { CandidateSchema } from '../employee-subsystem/employee/models/candidate.schema';
import { CandidateStatus } from '../employee-subsystem/employee/enums/employee-profile.enums';
